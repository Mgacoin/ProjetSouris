========================================================================
    APPLICATION WIN32 : Vue d'ensemble du projet Win32Project1
========================================================================

AppWizard a créé cette application Win32Project1 pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application Win32Project1.
...
Win32Project1.ico
    Il s'agit d'un fichier icône, qui est utilisé comme icône de l'application (32x32). Cette icône est incluse par le fichier de ressources principal Win32Project1.rc.

small.ico
    Il s'agit d'un fichier icône qui contient une version plus petite (16x16) de l'icône de l'application. Cette icône est incluse par le fichier de ressources principal Win32Project1.rc.

/////////////////////////////////////////////////////////////////////////////
Autres fichiers standard :

StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) Win32Project1.pch et un fichier de type précompilé nommé StdAfx.obj.
